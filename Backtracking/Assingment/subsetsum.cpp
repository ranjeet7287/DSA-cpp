// Subset Sum
// Send Feedback
// You are given an array of integers and a target K. You have to find the count of
// subsets of the given array that sum up to K.
// Note:
...
// Each test case contains two lines. The first line of each test case will contain two space-separated integers N
//  and K, where N is the size of the given array and K is the target value. 
