...
// total of two paths, starting from the root and ending at the leaves which sum up to a\
//  value of K = 13.
//                2
//             /     \
//            3       9           | k=13 |
...
// reference to the root, which sums up to 13 but since it doesn't end at the leaf,
//  we discard it.
