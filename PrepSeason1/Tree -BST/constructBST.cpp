...
// Input format:
// The first line of input contains an integer, which denotes the value of n. The following line 
// contains n space separated integers, that denote the values of array.
// Output Format:
...
BinaryTreeNode<int> *help(int *arr,int start,int end)
{
    if(start>end){
        return NULL;
    }
    ...
    BinaryTreeNode<int> *leftans=help(arr,start,mid-1);
    BinaryTreeNode<int> *rightans=help(arr,mid+1,end);
    root->left=leftans;
    root->right=rightans;
    return root;
}
