...
// Write a function to append the last 'N' nodes towards the front of the singly linked list and returns 
...
// a single space. 
// The second line contains the integer value 'N'. It denotes the number of nodes to be moved from last to 
...
// Here, "90->61->67->100" is the list which represents the last 4 nodes. When we move
// this list to the front then the remaining part of the initial list which is, "10->6->77" is attached 
