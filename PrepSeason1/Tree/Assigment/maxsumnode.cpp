...
// data and data of all its child nodes is maximum. In the sum, data of the node
...
// nodes and so on and so forth for each node. The data of the nodes of the tree is separated 
// by space. 
// Output format :
